...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PopupMenu popup = new PopupMenu(this, null);
        ...
        if(requestActive) {
            ...
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (lastKnownLocation != null) {
                    ...
                    Toast.makeText(this, "Could not find location :( try again laterz", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e == null && objects.size() > 0) {
                    ...
                    Toast.makeText(RiderActivity.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
                }
